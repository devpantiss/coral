...
function ProjectsPage() {
  ...
  return <InnerPage eyebrow="Projects" title="Mining projects." accent="Controlled delivery." intro="A project-led approach connecting mine development, production, equipment, logistics and responsible rehabilitation." image="/coral/projects-hero.jpg" imageAlt="Grand integrated mining and infrastructure project with overland conveyor">
    ...
    <section className="coral-project-lifecycle"><div className="coral-shell"><div className="coral-project-lifecycle__head"><div className="coral-page-heading coral-page-heading--light"><p className="coral-eyebrow coral-eyebrow--light"><span /> Asset lifecycle</p><h2>Continuity at<br />every stage.</h2></div><p>One delivery architecture connects early technical decisions to operating performance and responsible closure.</p></div><div className="coral-project-lifecycle__showcase"><div className="coral-project-lifecycle__media"><video autoPlay muted loop playsInline poster="/coral/capabilities-overview.jpg" aria-label="Mining operation across the asset lifecycle"><source src="/hero_bg.mp4" type="video/mp4" /></video><span className="coral-project-lifecycle__media-shade" aria-hidden="true" /><div className="coral-project-lifecycle__scan" aria-hidden="true" /><div className="coral-project-lifecycle__media-top"><span><i /> Integrated delivery live</span><small>COR / MDO · 360°</small></div><div className="coral-project-lifecycle__media-copy"><small>One connected operating system</small><strong>From first study<br />to final landform.</strong></div><div className="coral-project-lifecycle__filmstrip"><figure><img src="/coral/port-logistics-loading.jpg" alt="Vessel bulk loading at port" loading="lazy" /><figcaption>Move / Deliver</figcaption></figure><figure><img src="/coral/mine-rehabilitation.jpg" alt="Restored post-mining landscape" loading="lazy" /><figcaption>Restore / Renew</figcaption></figure></div></div><ol>{stages.map(([stage, description], index) => <li key={stage}><span>{String(index + 1).padStart(2,"0")}</span><i aria-hidden="true"><b /></i><div><strong>{stage}</strong><small>{description}</small></div></li>)}</ol></div></div></section>
