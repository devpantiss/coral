...
function SustainabilityPage() {
  return <InnerPage eyebrow="Sustainability" title="Responsible from" accent="the first cut." intro="Environmental and social performance designed into the operating model—not managed around it." image="/coral/sustainability-hero.jpg" imageAlt="Progressively rehabilitated mine landscape with retention lake and native flora" video="/sustainability.mp4">
    ...
    <section className="coral-sustainability-feature"><img src="/coral/water-energy-stewardship.jpg" alt="Mine water treatment, rainwater harvesting and renewable solar energy stewardship" loading="lazy" /><div><p className="coral-eyebrow coral-eyebrow--light"><span /> Progressive rehabilitation</p><h2>Restore while the mine is still operating.</h2><p>Closure landforms, drainage, soil systems and native planting are more effective when rehabilitation advances alongside production.</p></div></section>
  </InnerPage>;
}
