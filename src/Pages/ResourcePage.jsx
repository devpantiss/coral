...
const content = {
  ...
  apps: { label: "Apps", title: "Connected tools.", accent: "Clearer decisions.", intro: "Access Coral’s digital applications and operational tools." },
};

export default function ResourcePage({ type }) {
  const page = content[type];
  return <InnerPage eyebrow={page.label} title={page.title} accent={page.accent} intro={page.intro}>
