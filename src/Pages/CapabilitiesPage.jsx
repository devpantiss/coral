...
function CapabilitiesPage() {
  ...
  return <InnerPage video="/shipping.mp4" eyebrow="What We Do" title="One operating system." accent="Every stage of mining." intro="Integrated expertise spanning land, people, equipment, production, processing, logistics and responsible closure." image="/coral/capabilities-overview.jpg" imageAlt="Panoramic aerial view of integrated open-pit mining operations">
    ...
    <section className="coral-capabilities-solutions" aria-labelledby="integrated-solutions-title"><div className="coral-shell">
      <header className="coral-capabilities-solutions__head"><div><p className="coral-eyebrow coral-eyebrow--light"><span /> Integrated solutions</p><h2 id="integrated-solutions-title">Capability across the<br /><em>complete mine lifecycle.</em></h2></div><div className="coral-capabilities-solutions__stats"><div><strong>{String(integratedSolutions.length).padStart(2, "0")}</strong><span>Solution verticals</span></div><div><strong>{integratedSolutions.reduce((total, solution) => total + solution.services.length, 0)}</strong><span>Core services</span></div><div><strong>360°</strong><span>Lifecycle coverage</span></div></div></header>
